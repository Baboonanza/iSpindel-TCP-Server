...
echo "<option value='specific_gravity.php'>$chart_filename_04</option>";
echo "<option value='angle.php'>$chart_filename_06</option>";
echo "<option value='specific_gravity_raw.php'>$chart_filename_08</option>";
...
// calculate delta denstiy
        ...
        echo "<td>" . number_format($dens,3) . "</td>";
        echo "<td>" . number_format($Ddens,3) . "</td>";
