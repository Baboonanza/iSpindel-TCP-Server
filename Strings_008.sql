...
('plato', 'first_y', 'Extrakt °P (Spindel)', 'Wort SG (Spindle)', 'Densità °P (Spindle)'),
...
('plato4', 'first_y', 'Extrakt °P', 'Wort SG', 'Densità °P'),
...
('plato4_delta', 'first_y', 'Delta Extrakt °P', 'Delta Wort SG', 'Delta densità °P'),
...
('plato4_ma', 'first_y', 'Extrakt °P (geglättet)', 'Wort SG (moving average)', 'Densità °P (curva livellata)'),
